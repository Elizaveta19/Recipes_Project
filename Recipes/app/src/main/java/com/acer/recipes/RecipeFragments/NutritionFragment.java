...
public class NutritionFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_2.setText(text_2 + Integer.toString(recipe.getCarbs().getTotalPer100g()) + measure);

        TextView tv_21 = (TextView) view.findViewById(R.id.carbs_dialy_percent);
        String text_21 = tv_21.getText().toString();
        tv_21.setText(Integer.toString(recipe.getCarbs().getDailyPer100g()) + text_21);

        TextView tv_22 = (TextView) view.findViewById(R.id.carbs_net);
        String text_22 = tv_22.getText().toString();
        tv_22.setText(text_22 + Integer.toString(recipe.getCarbs().getCarbsNetPer100g()) + measure);

        TextView tv_23 = (TextView) view.findViewById(R.id.fiber);
        String text_23 = tv_23.getText().toString();
        tv_23.setText(text_23 + Integer.toString(recipe.getCarbs().getFilberPer100g()) + measure);

        TextView tv_24 = (TextView) view.findViewById(R.id.sugars);
        String text_24 = tv_24.getText().toString();
        tv_24.setText(text_24 + Integer.toString(recipe.getCarbs().getSugarsPer100g()) + measure);
        //CARBS--------------------------------------
        ...
        tv_3.setText(text_3 + Integer.toString(recipe.getProtein().getTotalPer100g()) + measure);

        TextView tv_31 = (TextView) view.findViewById(R.id.protein_dialy_percent);
        String text_31 = tv_31.getText().toString();
        tv_31.setText(Integer.toString(recipe.getProtein().getDailyPer100g()) + text_31);
        //PROTEIN---------------------------------
